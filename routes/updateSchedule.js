...
router.post('/updateSchedule', function(req, res){
  ...
  User.find({"uid": req.session.id}).exec(function(err, docs){
    ...
    // console.log("docs[0] is " + docs[0]);
    // console.log("docs[0].savedToSchedule is " + docs[0].savedToSchedule);
    // console.log("req.savedShows is " + req.savedShows);


    // TODO: get saved shows from userPage.html
    var savedToSchedule = [];
